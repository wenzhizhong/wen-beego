...
var MCHNT_ROLE_STATUS_NORMAL = 1
var MCHNT_ROLE_STATUS_DISABLE = 0
var MCHNT_ROLE_STATUS_MAP = map[int]string{
	MCHNT_ROLE_STATUS_NORMAL:  "正常",
	MCHNT_ROLE_STATUS_DISABLE: "已禁用",
}
