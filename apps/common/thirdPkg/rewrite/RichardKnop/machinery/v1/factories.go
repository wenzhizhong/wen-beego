...
import (
	...
	eagerbroker "WenBeego/apps/common/thirdPkg/rewrite/RichardKnop/machinery/v1/brokers/eager"
	gcppubsubbroker "WenBeego/apps/common/thirdPkg/rewrite/RichardKnop/machinery/v1/brokers/gcppubsub"
	brokeriface "WenBeego/apps/common/thirdPkg/rewrite/RichardKnop/machinery/v1/brokers/iface"
	redisbroker "WenBeego/apps/common/thirdPkg/rewrite/RichardKnop/machinery/v1/brokers/redis"
	sqsbroker "WenBeego/apps/common/thirdPkg/rewrite/RichardKnop/machinery/v1/brokers/sqs"

	amqpbackend "WenBeego/apps/common/thirdPkg/rewrite/RichardKnop/machinery/v1/backends/amqp"
	dynamobackend "WenBeego/apps/common/thirdPkg/rewrite/RichardKnop/machinery/v1/backends/dynamodb"
	eagerbackend "WenBeego/apps/common/thirdPkg/rewrite/RichardKnop/machinery/v1/backends/eager"
	backendiface "WenBeego/apps/common/thirdPkg/rewrite/RichardKnop/machinery/v1/backends/iface"
	memcachebackend "WenBeego/apps/common/thirdPkg/rewrite/RichardKnop/machinery/v1/backends/memcache"
	mongobackend "WenBeego/apps/common/thirdPkg/rewrite/RichardKnop/machinery/v1/backends/mongo"
	nullbackend "WenBeego/apps/common/thirdPkg/rewrite/RichardKnop/machinery/v1/backends/null"
	redisbackend "WenBeego/apps/common/thirdPkg/rewrite/RichardKnop/machinery/v1/backends/redis"

	eagerlock "WenBeego/apps/common/thirdPkg/rewrite/RichardKnop/machinery/v1/locks/eager"
	lockiface "WenBeego/apps/common/thirdPkg/rewrite/RichardKnop/machinery/v1/locks/iface"
	redislock "WenBeego/apps/common/thirdPkg/rewrite/RichardKnop/machinery/v1/locks/redis"
)
