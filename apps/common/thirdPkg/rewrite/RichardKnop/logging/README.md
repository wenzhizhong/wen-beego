...
[![godoc for RichardKnop/logging](https://godoc.org/github.com/nathany/looper?status.svg)](http://godoc.org/WenBeego/apps/common/thirdPkg/rewrite/RichardKnop/logging)
...
import (
	"WenBeego/apps/common/thirdPkg/rewrite/RichardKnop/logging"
)
