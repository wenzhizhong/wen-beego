...
func GetUserMenu[MenuModel models.ModelInterface, RoleMenuModel models.ModelInterface, UserRoleModel models.ModelInterface, RoleModel models.ModelInterface](moduleName string, unitId string, userId string, menuModel MenuModel, roleMenuModel RoleMenuModel, userRoleModel UserRoleModel, roleModel RoleModel) (menuAuthList []dto.RoleMenuDto, err error) {
	if unitId == "" || userId == "" {
...
func GetUserPermissions[MenuModel models.ModelInterface, MenuPermsModel models.ModelInterface, RoleMenuModel models.ModelInterface, UserRoleModel models.ModelInterface, RoleModel models.ModelInterface](moduleName string, unitId string, userId string, menuModel MenuModel, menuPermsModel MenuPermsModel, roleMenuModel RoleMenuModel, userRoleModel UserRoleModel, roleModel RoleModel) (menuPermsList []map[string]interface{}, err error) {
	if unitId == "" || userId == "" {
		str := fmt.Sprintf("GetUserMenu():获取菜单权限必填参数, unit_id:%s, classifyName:%s", unitId, userId)
		global.Log.Error(str)
