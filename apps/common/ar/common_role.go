 ...
 */
func GetUserRole[UserRoleModel models.ModelInterface, RoleModel models.ModelInterface](moduleName string, unitId string, userId string, userRoleModel UserRoleModel, roleModel RoleModel) (rolesList []RoleModel, err error) {
	if unitId == "" || userId == "" {
