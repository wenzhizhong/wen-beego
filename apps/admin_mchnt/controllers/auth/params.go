...
import (
	...
	comonAuthService "WenBeego/apps/common/services/auth"
)
...
// 获取参数-模型常量参数
// @Summary 获取参数-模型常量参数
// @Discription 获取参数-模型常量参数
// @Tags 参数
// @Success 200 {object} dto.Response "返回结果"
// @Router /admin_mchnt/auth-params/model-params [get]
func (c *ParamsController) GetModelParams() {
	data := map[string]interface{}{
		"modelParam": comonAuthService.GetAllModelConstant(),
	}
