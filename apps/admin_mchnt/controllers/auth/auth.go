...
import (
	...
	authService "WenBeego/apps/admin_mchnt/services/auth"
...
// @Router       /admin_mchnt/auth/login [post]
...
// @Success      200  {object}  dto.Response
// @Failure      0  {object}  dto.Response
// @Router       /admin_mchnt/auth/logout [post]
// @Security     ApiKeyAuth
...
// @Success      200  {object}  dto.Response
// @Failure      0  {object}  dto.Response
// @Router       /admin_mchnt/auth/refresh-token [post]
// @Security     ApiKeyAuth
