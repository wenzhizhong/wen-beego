...
func init() {
	...
	// })
	beego.InsertFilter("/admin_plat/*", beego.FinishRouter, new(blocker.AccessMiddleware).RouterAfter(&platWhiteApiList, &platAuthApiList), beego.WithReturnOnOutput(false))
